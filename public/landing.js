...
*/
          ...
          _renderZeroDurationTween = function _renderZeroDurationTween(
            ...
            var prevRatio = tween.ratio,
              ratio =
                totalTime < 0 ||
                (prevRatio && !totalTime && !tween._start && !tween._dp._lock)
                  ? 0
                  : 1,
        ...
        _forEachName('Linear,Quad,Cubic,Quart,Quint,Strong', function (
          name,
          i
        ) {
          var power = i < 5 ? i + 1 : i;
        ...
        */
                ...
                while (child) {
                  ...
                  if (
                    ...
                    if (time !== this._time || (!this._ts && !prevPaused)) {
                      ...
                      pauseTween = 0;
                      next &&
                        (tTime += this._zTime = adjustedTime
                          ? -_tinyNum
                          : _tinyNum); // it didn't finish rendering, so adjust zTime so that so that the next time render() is called it'll be forced (to render any remaining children)
        ...
        _forEachName('to,from,fromTo,delayedCall,set,killTweensOf', function (
          name
        ) {
  ...
  */
          ...
          _getComputedTransformMatrixAsArray = function _getComputedTransformMatrixAsArray(
            target
          ) {
        ...
        (0, _gsapCore._forEachName)('padding,margin,Width,Radius', function (
          name,
          index
        ) {
          var t = 'Top',
        ...
        var Cursor = /*#__PURE__*/ (function () {
          function Cursor(el) {
            ...
            this.onMouseMoveEv = function () {
              ...
              _this.renderedStyles.ty.previous = _this.renderedStyles.ty.previous =
          ...
          _createClass(GridItem, [
            {
              ...
              value: function move() {
                ...
                var render = function render() {
                  ...
                  translationVals.tx = (0, _utils.lerp)(
                    translationVals.tx,
                    (0, _utils.map)(
                      mousepos.x,
                      100,
                  ...
                  translationVals.ty = (0, _utils.lerp)(
                    translationVals.ty,
                    (0, _utils.map)(
                      mousepos.y,
                      100,
